...
<div class="fancy-divider"></div>
    ...
    <section id="softwares">
      <div class="container">
        <h2 style="text-align: center; color: var(--accent); margin-bottom: 20px;">Our Software Solutions</h2>
        <p style="text-align: center; color: var(--muted); max-width: 700px; margin: 0 auto 40px; line-height: 1.6;">Explore our comprehensive range of software products designed to streamline your business operations and enhance productivity.</p>
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
          <div style="background: rgba(59, 130, 246, 0.08); border: 1px solid rgba(147, 197, 253, 0.25); border-radius: 16px; padding: 30px; text-align: center; transition: all 0.3s ease; backdrop-filter: blur(10px); box-shadow: 0 8px 32px rgba(59, 130, 246, 0.08);">
            <h3 style="color: var(--accent); margin-bottom: 15px;">Hivex POS</h3>
            <p style="color: var(--muted); margin-bottom: 20px;">Complete Point of Sale system designed for retail and hospitality businesses.</p>
            <a href="https://pos.hivexlabs.co.ke" style="display: inline-block; padding: 12px 24px; background: var(--accent); color: #fff; text-decoration: none; border-radius: 8px; font-weight: 700; transition: all 0.3s ease;" target="_blank">Learn More</a>
          </div>
          <div style="background: rgba(59, 130, 246, 0.08); border: 1px solid rgba(147, 197, 253, 0.25); border-radius: 16px; padding: 30px; text-align: center; transition: all 0.3s ease; backdrop-filter: blur(10px); box-shadow: 0 8px 32px rgba(59, 130, 246, 0.08);">
            <h3 style="color: var(--accent); margin-bottom: 15px;">University/College Portal</h3>
            <p style="color: var(--muted); margin-bottom: 20px;">Comprehensive academic management portal for educational institutions.</p>
            <a href="product.php?type=university" style="display: inline-block; padding: 12px 24px; background: var(--accent); color: #fff; text-decoration: none; border-radius: 8px; font-weight: 700; transition: all 0.3s ease;">Learn More</a>
          </div>
          <div style="background: rgba(59, 130, 246, 0.08); border: 1px solid rgba(147, 197, 253, 0.25); border-radius: 16px; padding: 30px; text-align: center; transition: all 0.3s ease; backdrop-filter: blur(10px); box-shadow: 0 8px 32px rgba(59, 130, 246, 0.08);">
            <h3 style="color: var(--accent); margin-bottom: 15px;">HiveX Rental Management</h3>
            <p style="color: var(--muted); margin-bottom: 20px;">Complete property and equipment rental management system.</p>
            <a href="product.php?type=rental" style="display: inline-block; padding: 12px 24px; background: var(--accent); color: #fff; text-decoration: none; border-radius: 8px; font-weight: 700; transition: all 0.3s ease;">Learn More</a>
          </div>
          <div style="background: rgba(59, 130, 246, 0.08); border: 1px solid rgba(147, 197, 253, 0.25); border-radius: 16px; padding: 30px; text-align: center; transition: all 0.3s ease; backdrop-filter: blur(10px); box-shadow: 0 8px 32px rgba(59, 130, 246, 0.08);">
            <h3 style="color: var(--accent); margin-bottom: 15px;">HiveX Return on Investment</h3>
            <p style="color: var(--muted); margin-bottom: 20px;">Investment tracking and analysis platform.</p>
            <a href="product.php?type=roi" style="display: inline-block; padding: 12px 24px; background: var(--accent); color: #fff; text-decoration: none; border-radius: 8px; font-weight: 700; transition: all 0.3s ease;">Learn More</a>
          </div>
        </div>
      </div>
    </section>
